...
def match(name,sex,birthday,addr):
        ...
        for k in range(res_final.__len__()):
            query_insert = "update zmap_r_patient_empi_jb set empi_id =" + "'" + str(uuid.uuid1()) + "'" + "where patient_name =" + "'" + str(res_final[k][1]) + "'" + "and sex =" + "'" + str(res_final[k][2]) + "'" + "and addr =" + "'" + str(res_final[k][4]) + "'"
